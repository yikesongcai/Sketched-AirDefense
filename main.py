...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        dataset = datasets.MNIST('/opt/data/mnist', train=True, download=True, transform=trans_mnist)
        dataset_test = datasets.MNIST('/opt/data/mnist', train=False, download=True, transform=trans_mnist)
        ...
        dataset = datasets.CIFAR10('/opt/data/cifar', train=True, download=True, transform=trans_cifar_train)
        dataset_test = datasets.CIFAR10('/opt/data/cifar', train=False, download=True, transform=trans_cifar_test)
